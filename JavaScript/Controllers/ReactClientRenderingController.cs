...
namespace AspNetCoreJavaScript.Controllers
{
    ...
    {
        private string instanceId = "React";
        ...
        public ReactClientRenderingController(IQueryBuilderService aqbs, IHostingEnvironment env, IConfiguration config)
        {
            _aqbs = aqbs;
            _env = env;
            _config = config;
        ...
        public void CreateQueryBuilder()
        {
            ...
            var queryBuilder = _aqbs.Create("React");
